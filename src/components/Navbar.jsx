...
const Navbar = () => {
  ...
  return (
    <div className="border-b border-gray-200 relative">
      {/* Top Bar with Profile Dropdown Wrapper */}
      <div className="relative">
        ...
        {showProfileDropdown && (
          <div
            className="absolute right-6 top-full bg-white shadow-lg rounded-md py-2 w-48 z-30 border border-gray-100"
            onMouseEnter={() => setShowProfileDropdown(true)}
      ...
      <div className="relative">
        <nav className="bg-white px-10 py-2 flex justify-between items-center relative z-20">
          ...
          <div className="relative w-full max-w-4xl mx-auto">
            <ul className="flex justify-center space-x-6 font-semibold text-sm">
              {navItems.map((item) => (
                <li
                  key={item}
        ...
        {activeMenu && (
          <div
            className="absolute left-0 w-full bg-white shadow-lg border-t z-10"
            style={{ height: "400px" }}
